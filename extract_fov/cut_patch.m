function img_patch = cut_patch(a, longitude, latitude, fov_horizontal, fov_vertical)
    ...
    anglex = (180 * fov_horizontal / sizeiny) * pi / 180;
    angley = (180 * fov_vertical / sizeiny) * pi / 180;
    ...
    for ii = 1:sizeoutx
        for jj = 1:sizeouty
            ...
            if thetaf >= sizeiny
                ...
                img_patch(jj, ii) = (1 - p) * (1 - q) * a(thetaf, mod(phif - 1, sizeinx) + 1) + ...
                                    (1 - p) * q * a(thetaf, mod(phif, sizeinx) + 1) + ...
                                    p * (1 - q) * a(thetaf + 1, mod(phif - 1, sizeinx) + 1) + ...
                                    p * q * a(thetaf + 1, mod(phif, sizeinx) + 1);
            end
        end
    end
end
